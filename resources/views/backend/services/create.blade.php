        ...
        <form action="{{ route('admin.services.store') }}" method="POST">
            ...
            <div class="mb-3">
                ...
                <div class="input-group">
                    <input type="text" class="form-control" id="image" name="image" value="{{ old('image') }}" readonly>
                ...
                <div id="imagePreview" class="mt-2 {{ old('image') ? '' : 'd-none' }}">
                    <img src="{{ old('image') ? asset(old('image')) : '' }}" class="img-thumbnail" style="max-height: 150px;">
                </div>
            </div>
