...
<div class="card shadow-sm">
    <div class="card-header bg-white py-3 d-flex justify-content-between align-items-center">
        ...
        <div>
            <a href="{{ route('service', $service->slug) }}" class="btn btn-sm btn-outline-info" target="_blank">
                <i class="fas fa-external-link-alt me-1"></i> View on Site
            </a>
            <a href="{{ route('admin.services.index') }}" class="btn btn-sm btn-outline-secondary ms-1">
            ...
            <div class="row">
                ...
                <div class="col-md-8">
                    ...
                    <div class="mb-3">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control bg-light" id="slug" value="{{ $service->slug }}" disabled>
                        </div>
                        <small class="text-muted">Automatically generated from the title.</small>
                    </div>
                    
                    <div class="mb-3">
                        <label for="short_description" class="form-label fw-semibold">Short Description</label>
                        <textarea class="form-control" id="short_description" name="short_description" rows="2" required>{{ old('short_description', $service->short_description) }}</textarea>
                        <small class="text-muted">Brief description for service listings.</small>
                    </div>
                    
                    <div class="mb-3">
                        <label for="content" class="form-label fw-semibold">Content</label>
                        <textarea class="form-control summernote" id="content" name="content" rows="8">{{ old('content', $service->content) }}</textarea>
                    </div>
                </div>
                ...
                <div class="col-md-4">
                    <div class="card shadow-sm mb-3">
                        ...
                        <div class="card-body">
                            <div id="imagePreview" class="text-center mb-3 {{ old('image', $service->image) ? '' : 'd-none' }}">
                                <img src="{{ old('image', $service->image) ? asset(old('image', $service->image)) : '' }}" class="img-fluid rounded" style="max-height: 150px;">
                            </div>
                            
                            <div class="input-group">
                                <input type="text" class="form-control form-control-sm" id="image" name="image" value="{{ old('image', $service->image) }}" readonly>
                    ...
                    <div class="card shadow-sm mb-3">
                        ...
                        <div class="card-body">
                            <div class="mb-3">
                                ...
                                <input type="number" class="form-control form-control-sm" id="order" name="order" value="{{ old('order', $service->order) }}">
                            </div>
